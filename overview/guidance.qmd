...
description: "A checklist of things to consider when starting an open-source project."
---

Points to consider (not necessarily in this order):

- Do you intend to publish with/without the commit history? 
    - If sharing the full commit history is justified consider an "open from the start" approach where active development is done in the open. 
    - Otherwise, a full readthrough of every commit, checking for organisational risks and vulnerabilities, is required.
