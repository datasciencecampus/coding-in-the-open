...
[Open at the start](/open-development/open-at-start.qmd) | Placeholder page for guidance on considerations when developing in the open. |
[Open at the end](/private_to_public/guidance.qmd) | Provides guidance on moving work from a private domain into the public. This includes a checklist and flowchart to provide additional support when applying the guidance. |
[Never open](/private/private-development.qmd) | Reasons why code may not be published and how to document this. |
[What could go wrong?](/www-ebi/resolving-problems.qmd) | Risks to consider when we open source code. |
