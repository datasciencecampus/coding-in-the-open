...
A [helpful process diagram](/private_to_public//process-chart.qmd) summarises the approach.
...
Unit tests make it easier for you as a code owner to implement changes and accept contributions from other people. Why? Because if you have good test coverage, you can quickly see if someone else's cool new feature breaks the rest of your pre-existing code. Without these, there is a much bigger overhead to accepting contributions, because you will want to run tests yourself manually to check this or risk errors popping up when you really don't want them. 
...
It's also worth asking a senior colleague or manager to review your risk assessment. You might need to explain some of the things on there, but the idea is that you are giving others an opportunity to challenge, because risk assessments are subjective and there may be things you haven't thought of. 
