...
and guidance on planning for potential freedom of information requests.
...
Even if the developer is expert, the risk in maintaining this code if only one
person within the organisation understands it is too high to recommend.
:::
