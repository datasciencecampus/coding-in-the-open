...
source scrutiny and automated behavioural checks offer. One can question, 
if a codebase does not warrant the effort to test logic is correct and 
behaviours are stable and expected, then can it warrant closed-source development?
...
the risk and scope of potential FoI requests. This article intends to help the
reader gain an appreciation of the situation where closed-source is more
